...
### Phase 2 — Recruitment (planned)

`hire`, `onboard`, `fire`, `dept create`, `dept assign` — see future `operations/*.md`.

### Phase 3 — Mobility & Outsource (planned)

`transfer`, `second`, `promote`, `demote`, `outsource hire`, `contract`, `set-model`.

### Phase 4 — OKR & Gamification (planned)

`okr set`, `okr review`, `award-xp`, `dashboard`.
